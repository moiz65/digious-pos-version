...
<table width="100%" cellspacing="0" cellpadding="10" style="margin-top: 40px;">
    ...
    @elseif($payment->payment_type == \App\Models\SalesPayment::BANK_TRANSFER)  
        Bank Transfer  
    @elseif($payment->payment_type == \App\Models\SalesPayment::CREDIT_CARD)  
        Credit Card    {{-- New payment type --}}  
    @elseif($payment->payment_type == \App\Models\SalesPayment::FOODPANDA_CC)  
        Foodpanda CC   {{-- New payment type --}}  
    @elseif($payment->payment_type == \App\Models\SalesPayment::FOODPANDA_COD)  
        Foodpanda COD   {{-- New payment type --}}  
    @else  
        N/A  
    @endif  
</td>
