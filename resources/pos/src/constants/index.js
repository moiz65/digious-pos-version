...
export const paymentMethodOptions = [  
    ...
    { id: 2, name: "payment-type.filter.bank-transfer.label" }, // Kept existing bank transfer  
    { id: 3, name: "payment-type.filter.credit-card.label" },    // New payment type  
    { id: 4, name: "payment-type.filter.foodpanda-cc.label" },  // New payment type  
    { id: 5, name: "payment-type.filter.foodpanda-cod.label" },  // New payment type  
];
