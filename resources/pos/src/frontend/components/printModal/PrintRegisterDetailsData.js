...
class PrintRegisterDetailsData extends React.PureComponent {
    ...
    <tbody>  
        ...
        <tr style={{ width: "100%", borderBottom: "1px solid #DEE2E6" }}>  
            ...
            >  
                {getFormattedMessage("payment-type.filter.credit-card.label")}  
            </td>  
            <td  
                style={{  
                    fontSize: "12px",  
            ...
            >  
                <span>  
                    {currencySymbolHandling(  
                        allConfigData,  
                        currencySymbol,  
                        closeRegisterDetails?.today_sales_credit_card_payment  
                    )}  
                </span>  
            </td>  
        </tr>  
        <tr style={{ width: "100%", borderBottom: "1px solid #DEE2E6" }}>  
            ...
            >  
                {getFormattedMessage("payment-type.filter.foodpanda-cc.label")}  
            </td>  
            <td  
                style={{  
                    fontSize: "12px",  
            ...
            >  
                <span>  
                    {currencySymbolHandling(  
                        allConfigData,  
                        currencySymbol,  
                        closeRegisterDetails?.today_sales_foodpanda_cc_payment  
                    )}  
                </span>  
            </td>  
        </tr>  
        <tr style={{ width: "100%", borderBottom: "1px solid #DEE2E6" }}>  
            ...
            >  
                {getFormattedMessage("payment-type.filter.foodpanda-cod.label")}  
            </td>  
            <td  
                style={{  
                    fontSize: "12px",  
            ...
            >  
                <span>  
                    {currencySymbolHandling(  
                        allConfigData,  
                        currencySymbol,  
                        closeRegisterDetails?.today_sales_foodpanda_cod_payment  
                    )}  
                </span>  
            </td>  
        </tr>  
