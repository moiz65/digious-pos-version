...
const CustomerForm = (props) => {
    ...
    const disabled =
        ...
        const handleValidation = () => {
            ...
            // Remove the other validation checks for phone, country, city, and address
            else {
                isValid = true;
            }
            setErrors(errorss);
    ...
    const onChangeInput = (e) => {
        ...
        if (!value && !isRequiredField(name)) {
            setCustomerValue((previousState) => ({ ...previousState, [name]: null }));
        } else {
            setCustomerValue((previousState) => ({ ...previousState, [name]: value }));
        }
    };
