 ...
 * @property float|null $credit_card  
 * @property float|null $foodpanda_cc  
 * @property float|null $foodpanda_cod  
 *
 ...
 * @method static \Illuminate\Database\Eloquent\Builder|POSRegister whereCreditCard($value)      // New payment type  
 * @method static \Illuminate\Database\Eloquent\Builder|POSRegister whereFoodpandaCc($value)    // New payment type  
 * @method static \Illuminate\Database\Eloquent\Builder|POSRegister whereFoodpandaCod($value)   // New payment type  
...
'credit_card' => 'double', // New payment type  
'foodpanda_cc' => 'double', // New payment type  
'foodpanda_cod' => 'double', // New payment type
        'notes' => 'string',
        'total_sale' => 'double',
        'total_return' => 'double',
        'total_amount' => 'double',
