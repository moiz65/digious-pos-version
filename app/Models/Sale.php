...
{  
    ...
    const CREDIT_CARD = 3; // New payment type  
    const FOODPANDA_CC = 4; // New payment type  
    const FOODPANDA_COD = 5; // New payment type  
    ...
    protected $fillable = [  
        ...
        'received_amount',  
        'paid_amount',  
        'payment_type', // Ensure it's present  
        'note',  
        'status',  
        'payment_status',  
        'reference_code',  
    ...
    public static $rules = [  
        ...
        'payment_type' => 'numeric|integer|in:1,2,3,4,5', // Update validation rules  
        'notes' => 'nullable',  
